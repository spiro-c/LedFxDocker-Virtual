...
if [[ $(dpkg --print-architecture) ==  "armhf" ]] || [[ $(dpkg --print-architecture) == "arm64" ]]; then
    ...
    dpkg -i snapclient_0.24.0-1_armhf.deb
else
    wget https://github.com/badaix/snapcast/releases/download/v0.24.0/snapclient_0.24.0-1_amd64.deb
    dpkg -i snapclient_0.24.0-1_amd64.deb
fi
